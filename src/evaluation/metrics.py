...
def compute_overlap_percentage(ground_truth: MinimalSource, retrieved: Chunk) -> float:
    """
...
def compute_recall_at_k_for_question(ground_truth_sources: List[MinimalSource], retrieved_chunks: List[Chunk], k: int) -> float:
    """
